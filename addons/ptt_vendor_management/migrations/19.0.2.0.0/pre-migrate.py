...
This migration:
1. Removes the x_is_vendor field and standardizes vendor identification on supplier_rank
...
def migrate(cr, version):
    ...
    if cr.fetchone():
        # Ensure all partners with x_is_vendor = True have supplier_rank >= 1
        cr.execute("""
            UPDATE res_partner
        ...
        _logger.info(f"PTT Vendor Management: Updated supplier_rank for {updated_count} vendors")
    ...
    field_renames = [
        ('x_vendor_service_tag_ids', 'ptt_vendor_service_tag_ids'),
